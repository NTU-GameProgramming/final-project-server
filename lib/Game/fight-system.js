...
var FightSystem = function (game_tree, r, angle, attack_power) { // angle in degree
	...
	console.log("rr = " + this._rr);
	console.log("crit = " + this._critical_cos);
	console.log("atk_power = " + this._attack_power);
};
...
FightSystem.prototype = {
	attack: function(attacker) {
		...
		if(dist2 < this._rr) {
			...
			console.log("cos_val : " + cos_val + ", critical : " + this._critical_cos);
